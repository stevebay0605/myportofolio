  ...
  return (
    ...
    >
      <nav className="container mx-auto px-6 flex items-center justify-between">
        ...
        >
          <span className="text-foreground transition-colors group-hover:text-primary">Steve</span>
      ...
      <div
        className={cn(
          "md:hidden fixed inset-x-0 top-[72px] glass transition-all duration-300 overflow-hidden",
