...
const contactMethods = [
  {
    ...
    title: "Email",
    value: "bayonnestevekelly@gmail.com",
    href: "mailto:bayonnestevekelly@gmail.com",
    description: "Envoyez-moi un email",
  },
  {
    icon: <Phone className="w-6 h-6" />,
    title: "Telephone",
    value: "+242 06 933 9097",
    href: "tel:+242069339097",
...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/steve-bayonne",
    icon: (
  ...
  {
    name: "GitHub",
    href: "https://github.com/stevebay0605",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/steve.bayonne.54",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Contact() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // In production, this would be replaced with actual EmailJS or API call
    ...
    <section ref={sectionRef} id="contact" className="relative py-24">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className={`text-center mb-16 ${isVisible ? "animate-slide-up" : "opacity-0"}`}>
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-2 gradient-text">Contact</h2>
          ...
          >
            ...
            <div className="space-y-4">
              {contactMethods.map((method, index) => (
                <div
                  key={method.title}
                  className={`flex items-start gap-4 p-4 rounded-xl glass border border-border/50 hover:border-primary/30 transition-all duration-300 ${
            ...
            <div
              ...
              style={{ animationFillMode: "both" }}
            >
              <h3 className="font-semibold text-foreground mb-4">Retrouvez-moi sur</h3>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground glow-blue disabled:opacity-50"
              >
